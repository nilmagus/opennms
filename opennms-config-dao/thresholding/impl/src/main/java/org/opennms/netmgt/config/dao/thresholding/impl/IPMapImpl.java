...
import org.opennms.netmgt.config.dao.thresholding.api.ThreshdIPMap;
...
public class IPMapImpl implements ThreshdIPMap {
    private static final Logger LOG = LoggerFactory.getLogger(IPMapImpl.class);
    ...
    private final ReadableThreshdDAO threshdDAO;

    public IPMapImpl(ReadableThreshdDAO threshdDAO) {
    ...
    private void createUrlIpMap() {
        for (Package pkg : threshdDAO.getConfig().getPackages()) {
    ...
    private void createPackageIpListMap() {
        for (final org.opennms.netmgt.config.threshd.Package pkg : threshdDAO.getConfig().getPackages()) {
            //
