...
./maven/bin/mvn -P'!checkstyle' --fail-never -Dmaven.test.failure.ignore=true -DupdatePolicy=never -DskipITs=false -DskipTests=false --batch-mode -pl ${MODULES_TO_TEST} verify
